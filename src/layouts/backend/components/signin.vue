                    ...
                    <div class="content">
                        <el-form @keyup.enter="onSubmit(formRef)" ref="formRef" :rules="rules" size="large"
                            ...
                            <el-form-item prop="email">
                                <el-input ref="emailRef" type="text" clearable v-model="form.email"
                                    :placeholder="t('Please enter an email')">
                                    <template #prefix>
                                        <Icon name="fa fa-envelope" class="form-item-icon" size="16"
                            ...
                            <el-form-item prop="password">
                                <el-input ref="passwordRef" v-model="form.password" type="password"
                                    :placeholder="t('adminLogin.Please input a password')" show-password>
                                    <template #prefix>
...
import { validatorPassword, validatorEmail, validatorAccount } from "/@/utils/validate";
...
axios.post('auth/password-login', form)
.then( res => {
